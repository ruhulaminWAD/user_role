                ...
                <div class="tab-content padding-0">
                    <div class="tab-pane blog-page active" id="Overview">
                        ...
                        <div class="card single_post2">
                            <img class="img-fluid" src="{{ asset('backend') }}/assets/images/blog/blog-page-1.jpg" alt="img">
                            <div class="body">
                                <div class="content">
                        ...
                        <div class="card single_post2">
                            <img class="img-fluid" src="{{ asset('backend') }}/assets/images/blog/blog-page-2.jpg" alt="img">
                            <div class="body">
                                <div class="content">
                                    <div class="actions_sidebar">
                                        <a href="javascript:void(0)"><i class="icon-share"></i></a>
...
<script src="{{ asset('backend') }}/assetsLite/bundles/knob.bundle.js"></script><!-- Jquery Knob-->
