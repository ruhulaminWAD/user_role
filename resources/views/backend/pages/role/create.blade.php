                        ...
                        <div class="table-responsive check-all-parent">
                           <form action="{{ route('role.store') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('role_name') is-invalid @enderror" type="text" name="role_name" id="role_name" placeholder="Create a new role">
                                @error('role_name')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('role_note') is-invalid @enderror" name="role_note" id="role_note" cols="30" rows="3" placeholder="Enter a role note"></textarea>
                                @error('role_note')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
