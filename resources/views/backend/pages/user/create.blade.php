                        ...
                        <div class="table-responsive check-all-parent">
                           <form action="{{ route('user.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control @error('role_id') is-invalid @enderror" name="role_id" id="role_id">
                                        ...
                                        @foreach ($roles as $role )
                                            <option class="form-control" value="{{ $role->id }}">{{ $role->role_name }}</option>
                                        @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" placeholder="Create a new user">
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" name="email" id="email" placeholder="enter a email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
