                           ...
                           <form action="{{ route('permission.update', $permission->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control @error('module_id') is-invalid @enderror" name="module_id" id="module_id">
                                        ...
                                        @foreach ($modules as $module )
                                            <option class="form-control" value="{{ $module->id }}" @if ($permission->module_id == $module->id) selected @endif>{{ $module->module_name }}</option>
                                        @endforeach
                            ...
                            <div class="mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('permission_name') is-invalid @enderror" type="text" name="permission_name" id="permission_name" value="{{ $permission->permission_name }}">
